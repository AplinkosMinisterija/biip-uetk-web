...
import { handleErrorFromServerToast, handleSuccessToast } from '../utils/functions';
...
const TenantForm = () => {
  ...
  const updateUser = useMutation(
    async (values: TenantProps) =>
      tenant?.id ? api.updateTenant(tenant.id, values) : Promise.resolve(),
    {
      onError: () => {
